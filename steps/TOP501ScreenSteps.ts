...
export class TOP501ScreenSteps {
    private page: Page;
    ...
    async Search501(sgr: string, workshop: string): Promise<void> {
        ...
        await this.helper.clickElement(this.top0501ManageWorkstationsPage.top0501ManageWorkstations, "click on TOP0501 - Manage workstations");
        ...
        await this.helper.clickElement(this.top0501ManageWorkstationsPage.zonePenOption, "click on zone pen option button");
